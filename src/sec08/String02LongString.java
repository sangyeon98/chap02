...
public class String02LongString {
	...
	public static void main(String[] args) {
		...
		System.out.println("분리된 단어의 갯수는 : " + strArr.length); // 거의다 했는데 몇개인지 보려면 length사용
		...
		/**
		 * for(String strArr1 : strArr) { System.out.println(strArr1); }
		 */

		// 문제 1. 위의 str 데이터 중 "HTML5"라는 단어가 몇번 노출되는지
		// 노출 횟수를 resultNum이라는 배열 명으로 저장하여 출력
		...
		// for 문을 활용하여역순으로 출력하기
		String tempString = "우리는 세종대왕이 만든 빛나는 문화유산인 한글을 갖고 있다.";
		String[] arrStr = tempString.split(" ");
		for (int i = arrStr.length - 1; i >= 0; i--) { // 배열의 갯수는8인데 인덱스는 0부터시작이라 -1
			System.out.print(arrStr[i] + " ");
		}
		System.out.println();

		// 문제2. 위의 str데이터를 모두 역순(spcae기준)으로
